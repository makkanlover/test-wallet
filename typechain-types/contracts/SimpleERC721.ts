...
export interface SimpleERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface SimpleERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleERC721;
  ...
  mintNext: TypedContractMethod<[to: AddressLike], [bigint], "nonpayable">;
